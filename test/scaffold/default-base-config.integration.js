...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    smartcashd.spawn.datadir.should.equal(home + '/.bitcoin');
    smartcashd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/smartcashd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.smartcashd.spawn.datadir.should.equal('./data2');
  });
});
